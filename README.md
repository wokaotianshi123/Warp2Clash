...
1.用手机安装termux运行（https://github.com/termux/termux-app/releases），然后先安装python环境（首次运行需要，以后不需要），预计有600M，手机空间要足够。
``` 
pkg install python
```
2.获取读写sd卡权限，允许
...
5.下载安装最新版hiddify next（https://github.com/hiddify/hiddify-next/releases/），打开,右上角，剪贴板导入。
